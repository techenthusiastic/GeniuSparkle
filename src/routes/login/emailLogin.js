...
router.post("/initRegister", async (req, res, next) => {
	let reqBody;
	try {
...
router.get("/:action/:email/:mailUID", async (req, res, next) => {
...
// Initiate Email Send
router.post("/forgotPswd", async (req, res, next) => {
	let reqBody;
	try {
...
router.post("/resetPswd", async (req, res, next) => {
	let reqBody;
	try {
